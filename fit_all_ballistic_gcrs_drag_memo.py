...
OUTPUT_H5 = os.path.join("results", f"all_tristatic_ballistic_gcrs_drag_memo_{SCRIPT_VERSION}.h5")
OUTPUT_JSON = os.path.join("results", f"all_tristatic_ballistic_gcrs_drag_memo_{SCRIPT_VERSION}.json")
...
def fit_ballistic(
    ...
    def residual(x):
        pred, _x, _v, _b = predict_paths(x, t_rel_s, times_fit, rho_of_alt_m)
    ...
    pred, x_itrs, v_itrs, b_drag = predict_paths(result.x, t_rel_s, times_fit, rho_of_alt_m)
