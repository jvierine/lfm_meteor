...
DELTA_US = 4.0
STEP_US = 0.25
OUTPUT_H5 = os.path.join("results", "delay_grid_search_beam_axis_sample.h5")
OUTPUT_PNG = os.path.join("results", "delay_grid_search_beam_axis_sample.png")
...
def main():
    ...
    ax.set_title("Sample-step Beam-Axis Delay Search")
    fig.tight_layout()
