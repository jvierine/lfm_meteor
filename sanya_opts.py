...
# range origin.  After applying the satellite-derived Sanya one-way range
# correction, all three links use the same tx-target-rx zero-gate delay origin.
SANYA_FIRST_SAMPLE_DELAY_US = 466.320
SANYA_CORRECTED_TXRX_DELAY_US = (
    SANYA_FIRST_SAMPLE_DELAY_US + 2.0 * SANYA_RANGE_CORRECTION_KM * 1e3 / 299792458.0 * 1e6
)
DANZHOU_FIRST_SAMPLE_DELAY_US = SANYA_CORRECTED_TXRX_DELAY_US
WENCHANG_FIRST_SAMPLE_DELAY_US = SANYA_CORRECTED_TXRX_DELAY_US
