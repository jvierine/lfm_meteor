...
def lfm_total_path_bias_m(path_length_rate_mps):
    ...
    geometric_path - (f0/gamma) * path_length_rate.  Callers add this helper to
    the geometric tx-target-rx path when predicting measurements.
    """
...
def write_h5(path, fits):
    ...
    with h5py.File(path, "w") as h:
        ...
        h.attrs["lfm_total_path_bias_m"] = "validated satellite convention: c*f_D/chirp_rate = -(f0/chirp_rate)*path_length_rate"
